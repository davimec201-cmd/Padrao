...
class Bloco:
    ...
    origem_linha: int = 0
    # posição na lista escrita pelo autor, antes de capa/sumário/página final
    # entrarem. É este número que o relatório mostra e que `--correcoes` usa —
    # o índice depois da montagem não serve de endereço para ninguém.
    indice_fonte: int = -1
    ...
    def para_json(self) -> dict:
        return {
            ...
            "indice_fonte": self.indice_fonte,
    ...
    def de_json(cls, bruto: dict) -> "Bloco":
        return cls(
            ...
            indice_fonte=bruto.get("indice_fonte", -1),
