...
| **Alarme** | Gerado sem arquivo de som: toque de gol no fim do foco, apito de árbitro começando o jogo no fim da pausa. O toque vai **gravado dentro da trilha do bloco**, que corre em silêncio até o fim — assim ele soa com a tela bloqueada sem depender de nada rodando, e sem abaixar o som de outros apps enquanto tu estuda. O bloco aparece na barra de notificação, uma notificação avisa no fim, vibra quando o aparelho tem vibração, e o Wake Lock mantém a tela acesa durante o bloco, onde houver suporte. |
