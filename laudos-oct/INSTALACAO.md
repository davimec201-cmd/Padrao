# Instalação — skill `laudos-oct` (macOS)
...
Ele instala o que falta, cria `~/Laudos_OCT/` e roda o diagnóstico no fim.
...
cp ~/.claude/skills/laudos-oct/hardening/settings.json ~/.claude/settings.json
```
